...
<body>
    ...
    <div class="kop-container">
        <table width="100%">
            <tr>
                ...
                <td width="15%" align="center">
                    <img src="assets/images/Kemirigede.png" class="kop-logo">
                </td>
            </tr>
        </table>
        <hr class="kop-garis">
    ...
    <div class="isi">
        ...
        <p>Orang tersebut di atas adalah penduduk Desa Kemirigede, Kecamatan Kemirigede, Kabupaten Blitar yang benar-benar
